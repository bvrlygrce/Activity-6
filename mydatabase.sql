...
INSERT INTO `client_info` VALUES (1,'Bev','Borbe',1,2,1,2),(2,'Mary','Ala',2,3,2,5),(3,'Greys','Fortalejo',3,4,3,4),(4,'Ann','Llamera',4,1,4,3),(5,'Grace','Garcera',5,6,5,6),(6,'Rose','Belista',4,5,6,3),(7,'Khris','Ocampo',8,9,7,9),(8,'Joyce','Loterte',9,7,8,8),(9,'Keith','Masbate',6,5,9,8),(10,'Jay','Bracamonte',10,9,10,10),(11,'Kristine','Borbe',3,2,4,5),(12,'Eena','Masbate',4,5,6,7);
...
CREATE TABLE `login_form` (
  `idlogin_form` int NOT NULL,
  `username` varchar(45) NOT NULL,
  `password` varchar(45) NOT NULL,
  `email` varchar(45) NOT NULL,
  PRIMARY KEY (`idlogin_form`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `login_form` VALUES (1,'bev','123','bev@gmail.com'),(3,'k@gmail.com','keiszha','123'),(12,'zack@gmail.com','zack','123'),(111,'borbe@gmail.com','borbe','1111'),(123,'Greys@gmail.com','greys','1234');
...
INSERT INTO `price` VALUES (1,'50',1),(2,'1000',2),(3,'300',3),(4,'400',4),(5,'450',5),(6,'550',6),(7,'700',7),(8,'800',8),(9,'950',9),(10,'1000',10),(11,'1000',1);
...
INSERT INTO `prodprice` VALUES (1,1050),(2,1000),(3,300),(4,400),(5,450),(6,550),(7,700),(8,800),(9,950),(10,1000);
...
-- Dump completed on 2023-04-30 13:45:46
