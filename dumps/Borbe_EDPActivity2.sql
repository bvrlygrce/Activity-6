...
INSERT INTO `price` VALUES (1,'50'),(2,'100'),(3,'300'),(4,'400'),(5,'450'),(6,'550'),(7,'700'),(8,'800'),(9,'950'),(10,'1000');
...
INSERT INTO `totalprice` VALUES (1,50),(2,100),(3,200),(4,300),(5,400),(6,500),(7,600),(8,700),(9,800),(10,1000);
...
BEGIN
	update totalprice
    set totalprice = (select sum(price_unit) from price where price_Id= param1)
...
-- Dump completed on 2023-02-15 14:46:21
